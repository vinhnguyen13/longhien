...
class ProductsController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			/* upload file */
			$pFiles = $vmodel->upload('images');
			if(!empty($pFiles)){
// 				$postParams = $_POST['Products']['params'];
				$_POST['Products'] = array_merge($_POST['Products'], $pFiles);
// 				$_POST['Products']['params'] = array_merge($postParams, $pFiles['params']);
			}			

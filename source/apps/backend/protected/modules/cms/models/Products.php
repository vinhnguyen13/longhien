...
class Products extends CActiveRecord
{
	...
	public function relations()
	{
		...
		$relations['category'] = array(self::BELONGS_TO, 'Categories', 'catid');
		return $relations;
	}
	...
	public function search()
	{
		...
		$criteria->compare('fast_selling',$this->fast_selling);

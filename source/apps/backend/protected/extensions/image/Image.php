...
Yii::import('backend.extensions.image.Image_Driver');
...
class Image {
	...
	public function __construct($image, $config = NULL)
	{
        ...
        // Load the driver
        Yii::import("backend.extensions.image.drivers.$driver");
	...
	public function logo($logo_pathfile){
		$this->actions['logo'] =	$logo_pathfile;
	...
	{
		$this->actions['watermark'] =	$watermark_pathfile;

	...
	<div id="mainmenu">
		...
		$this->widget('zii.widgets.CMenu',array(
			'items'=>array(
                ...
                array('label'=>'Hãng', 'url'=>Yii::app()->createUrl('/cms/manufactory/admin'), 'active'=> (Yii::app()->controller->id=='manufactory') ? true : false),
                array('label'=>'Xuất xứ', 'url'=>Yii::app()->createUrl('/cms/madeIn/admin'), 'active'=> (Yii::app()->controller->id=='madeIn') ? true : false),
                array('label'=>'Nội dung', 'url'=>Yii::app()->createUrl('/cms/services/admin'), 'active'=> (Yii::app()->controller->id=='services') ? true : false),
                array('label'=>'Tin tức', 'url'=>Yii::app()->createUrl('/cms/news/admin'), 'active'=> (Yii::app()->controller->id=='news') ? true : false),
				array('label'=>'Hình Ảnh', 'url'=>array('/cms/advertising/admin'), 'active'=> (Yii::app()->controller->id=='advertising') ? true : false),
